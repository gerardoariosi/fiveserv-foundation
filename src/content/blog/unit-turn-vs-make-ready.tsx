...
const blocks: Block[] = [
  { type: "p", text: <><strong>FiveServ Property Solutions</strong> uses 'unit turn' and 'make-ready' interchangeably across all Central Florida service. The terms mean the same thing — but here's the nuance.</> },
