...
const blocks: Block[] = [
  { type: "p", text: <><strong>FiveServ Property Solutions</strong> provides both unit cleaning and full make-ready service across Central Florida. The two are not the same — here's the clear difference.</> },
