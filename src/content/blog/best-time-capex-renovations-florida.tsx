...
const blocks: Block[] = [
  { type: "p", text: <><strong>FiveServ Property Solutions</strong> schedules CapEx renovations during the low-leasing window across Central Florida. Here's the full seasonal breakdown of when to do what.</> },
