...
const MakeReadyGuideBody = () => (
  <div className="space-y-6 text-base leading-relaxed text-brand-white/90">
    ...
    <div className="overflow-x-auto rounded-lg border border-brand-gold/30">
      <table className="w-full text-sm">
        <thead className="bg-brand-gray/40">
          <tr>
            <th className="p-3 text-left text-gray-900">Day</th>
    ...
    <p>
      ...
      <Link to="/cities" className="text-gray-900 underline">Central Florida service area</Link>.
      If you want the full breakdown, the{" "}
      <Link to="/make-ready" className="text-gray-900 underline">make-ready service page</Link>{" "}
      shows the included scope and pricing tiers, or you can{" "}
      <Link to="/contact" className="text-gray-900 underline">request a quote</Link> for
