...
const blocks: Block[] = [
  { type: "p", text: <><strong>FiveServ Property Solutions</strong> runs a real 24/7 line — live person, licensed trades on-call, 2-hour on-site response. Here's how to verify any vendor's 24/7 claim before you sign.</> },
