...
const blocks: Block[] = [
  { type: "p", text: <><strong>FiveServ Property Solutions</strong> publishes this glossary as a free reference for Central Florida property managers and onsite teams. Copy it, share it, use it in onboarding.</> },
  { type: "h2", text: "A – C" },
  { type: "ul", items: [
