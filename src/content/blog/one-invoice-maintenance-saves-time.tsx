...
const blocks: Block[] = [
  { type: "p", text: <><strong><BrandName variant="dark" /> Property Solutions</strong> consolidates all property work into one monthly invoice across Central Florida. Here's the math behind why one-invoice maintenance saves PMs real time and money.</> },
