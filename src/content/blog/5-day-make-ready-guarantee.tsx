...
const blocks: Block[] = [
  { type: "p", text: <><strong><BrandName variant="dark" /> Property Solutions</strong> backs every Central Florida make-ready with a written 5-business-day guarantee. Here's exactly what that means and why most vendors won't offer one.</> },
  ...
  { type: "p", text: <><BrandName variant="dark" /> pays a daily lost-rent credit per the written agreement. Real number, calculated from your actual rent rate.</> },
  ...
  { type: "h2", text: <>Why <BrandName variant="dark" /> can</> },
