...
const blocks: Block[] = [
  { type: "p", text: <><strong><BrandName variant="dark" /> Property Solutions</strong> handles both CapEx and OpEx work for Central Florida multifamily portfolios, but the two are budgeted, accounted for, and quoted differently. Here's the complete breakdown.</> },
