...
const blocks: Block[] = [
  { type: "p", text: <><strong>FiveServ Property Solutions</strong> publishes flat-rate make-ready pricing across Central Florida so property managers can build accurate annual budgets. Here's the 2025 cost breakdown.</> },
