...
const blocks: Block[] = [
  { type: "p", text: <><strong><BrandName variant="dark" /> Property Solutions</strong> gets asked this every week by new property managers and onsite teams: what exactly is a unit turn? Here is the full definition, the standard scope, and why the answer affects your operating budget.</> },
