...
const blocks: Block[] = [
  { type: "p", text: <><strong>FiveServ Property Solutions</strong> runs this 40-item make-ready checklist on every Central Florida unit turn. Free for property managers — copy it, adapt it, and standardize inspections across your portfolio.</> },
