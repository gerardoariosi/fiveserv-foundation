...
const blocks: Block[] = [
  { type: "p", text: <><strong>FiveServ Property Solutions</strong> runs a 24/7 emergency plumbing line for Central Florida multifamily. Here's the step-by-step response playbook every onsite team should know cold.</> },
