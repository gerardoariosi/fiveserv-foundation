...
const blocks: Block[] = [
  { type: "p", text: <><strong>FiveServ Property Solutions</strong> guarantees a 5-business-day make-ready on standard scope across Central Florida. The honest answer to 'how long should it take' depends on vendor coordination, not unit complexity.</> },
