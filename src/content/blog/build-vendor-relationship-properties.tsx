...
const blocks: Block[] = [
  { type: "p", text: <><strong><BrandName variant="dark" /> Property Solutions</strong> has worked with multifamily operators in Central Florida for years, and the vendors that survive PM turnover and portfolio growth all share the same 5 traits. Here's how to build that kind of relationship.</> },
