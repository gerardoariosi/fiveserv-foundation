...
const blocks: Block[] = [
  { type: "p", text: <><strong><BrandName variant="dark" /> Property Solutions</strong> repairs drywall on every Central Florida make-ready. Knowing what's normal wear vs. damage that needs root-cause investigation protects both your turn budget and security-deposit defensibility.</> },
