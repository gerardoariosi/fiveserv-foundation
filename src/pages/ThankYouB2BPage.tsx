  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-brand-black px-6 py-12 text-center text-white">
        ...
        {/* Tagline */}
        <p className="mt-6 font-display italic text-gray-900 text-lg sm:text-xl">
        ...
        <div className="mt-12">
          ...
          <a
            href={telHref}
            className="mt-2 inline-block font-display text-2xl text-gray-900 hover:text-gray-700 sm:text-3xl"
          >
            {phone}
          </a>
        </div>
